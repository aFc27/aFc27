...
newtext = str.replace(texto, "Python", "Fython") #trocando Python por Fython
...
figurinhas_list = figurinhas.split(", ") #transformando a string numa lista
figurinhas_list.sort()                  #organizando em ordem alfabética
resultado = " ".join(figurinhas_list)   #retirando vírgulas excessivas
